...
public class GridHandler : MonoBehaviour
{
    ...
    public void initializePlaneBehaviour()
    {
        ...
        PlaneFunctionality spawnEnemyFunctionality = new PlaneFunctionality(Functionality.SpawnEnemy, AddLifeTexture, (PlaneHandler plane) => EnemySpawner.SpawnEnemy(), 0, false);
